<template>
    <div>
        ...
        小数位数：
        <Xb-Input-number name="he" v-model="v3" :autofocus="autofocus" :fixed="4" :max="10" :defaultnumber="0.00" :min="0"></Xb-Input-number>
        ...
        <xb-input-number v-model="v6" :max="10" name="he" :min="-1" style="width: 200px" hidestep :required="false" :fixed="2"></xb-input-number>
    </div>
</template>
<script>
export default {
