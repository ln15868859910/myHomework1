<template>
    <div style="width: 400px;margin: 200px;">
        <Collapse v-model="v1" accordion>
            <Panel name="1">
                <span class="spanName">史蒂夫·乔布斯</span>
                <div slot="content">
                    史蒂夫·乔布斯（Steve Jobs），1955年2月24日生于美国加利福尼亚州旧金山，美国发明家、企业家、美国苹果公司联合创办人。
                    <Collapse accordion v-model="value4" style="margin-top:25px;">
                        <Panel name="1-1">
                            <span class="spanName">iphone</span>
                            <p slot="content">iPhone，是美国苹果公司研发的智能手机，它搭载iOS操作系统。第一代iPhone于2007年1月9日由苹果公司前首席执行官史蒂夫·乔布斯发布，并在2007年6月29日正式发售。</p>
                        </Panel>
                        <Panel name="1-2">
                            <span class="spanName">ipad</span>
            ...
            <Panel name="2">
                <span class="spanName">斯蒂夫·盖瑞·沃兹尼亚克</span>
                <p slot="content">斯蒂夫·盖瑞·沃兹尼亚克（Stephen Gary Wozniak），美国电脑工程师，曾与史蒂夫·乔布斯合伙创立苹果电脑（今之苹果公司）。斯蒂夫·盖瑞·沃兹尼亚克曾就读于美国科罗拉多大学，后转学入美国著名高等学府加州大学伯克利分校（UC Berkeley）并获得电机工程及计算机（EECS）本科学位（1987年）。</p>
            </Panel>
            <Panel name="3">
                <span class="spanName">乔纳森·伊夫</span>
