...
export default {
  ...
  methods: {
    firstStrlowerCase(obj) {
      ...
      var strObj2 = strObj.replace(/(\")(\w*)(\"\:)/g, function(
        $0,
        $1,
        $2,
        $3
          ...
          MultiModel: {
            ModelList: [
              ...
              },
              {
                ...
                RemoteUrl: {
                  OnChange: null,
                  OnSearch: "/api/Teaching/GetClassRoomBySchoolIdForFilter"
                }
              },
              {
                SortName: "星标",
              ...
              },
              {
                ...
                RemoteUrl: {
                  OnChange: null,
                  OnSearch: "/api/Teaching/GetSubjectIdFilter"
                }
              },
              {
                SortName: "学年",
