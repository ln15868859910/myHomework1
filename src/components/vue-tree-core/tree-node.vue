...
<li ref="draggAbleEle" :class="draggingClass" data-wrap>
          ...
          <!--这里onDragStart事件和接收目标上的事件不能绑在同一个元素上，否则真机IE10下 会无法触发接收事件-->
            <div class="vue-tree-clearfix" :class="[nodeHandleClass,nodeData.prop.isChecked&&rootData.globalConfig.modal?'modal-check':'']" data-handle v-show="nodeData.title" @click="toggleChecboxByTitle">  
...
export default {
    ...
    computed: {
            ...
            return {
                'vue-tree-invisible':
                    'loading' in this.nodeData
                        ? false
                        : this.nodeData.isHiddenCollapseIcon || !this.nodeData.nodes.length,
        ...
        showArrow() {
            return (
                (this.nodeData.nodes && this.nodeData.nodes.length) ||
                ('loading' in this.nodeData && !this.nodeData.loading)
            );
        },
        showLoading() {
        ...
        checkboxClass() {
            ...
            return [
                ...
                this.rootData.globalConfig.styles.checkboxSelected
                    ? {
                          [this.rootData.globalConfig.styles.checkboxSelected]: this.nodeData.prop.isChecked
                      }
                    : { 'vue-tree-checkbox-selected': this.nodeData.prop.isChecked },
                this.rootData.globalConfig.styles.checkDisabled
                    ? {
                          [this.rootData.globalConfig.styles.checkDisabled]: this.nodeData.prop.isDisabled
                      }
        ...
        collapseStatus() {
            ...
            return [
                this.rootData.globalConfig.styles.iconCollapse
                    ? {
                          [this.rootData.globalConfig.styles.iconCollapse]: !this.nodeData.prop.isExpand
                      }
                    : { 'vue-node-collapse': !this.nodeData.prop.isExpand },
                this.rootData.globalConfig.styles.iconExpanded
                    ? {
                          [this.rootData.globalConfig.styles.iconExpanded]: this.nodeData.prop.isExpand
                      }
    ...
    methods: {
        ...
        setInitNodeValue() {
            //【prop属性类型校验】
            if ('prop' in this.nodeData && !this.checkThisType(this.nodeData.prop, 'object')) {
        ...
        onDragStart(e) {
            ...
            this.rootData.rootInstance.$emit('dragStart', {
        ...
        onDragEnter: debounce(function(e) {
            ...
            this.rootData.delayedDragEnterLogic[this.nodeData._hash] = setTimeout(function() {
                ...
                that.rootData.rootInstance.$emit('dragEnter', {
        ...
        onDragOver(e) {
            ...
            //当前节点禁止拖拽时
            if (!this.nodeData.prop.noDrop) {
                this.rootData.rootInstance.$emit('dragOver', {
                    treeNode: this.nodeData,
                    parentNode: this.parentNodeData,
                    event: e
                });
        ...
        onDragLeave(e) {
            ...
            this.rootData.rootInstance.$emit('dragLeave', {
                treeNode: this.nodeData,
                parentNode: this.parentNodeData,
                event: e
            });
        ...
        onDragEnd(e) {
            ...
            this.rootData.rootInstance.$emit('dragEnd', {
                treeNode: this.nodeData,
                parentNode: this.parentNodeData,
                event: e
            });
        ...
        key2FuncMap(key, dataList) {
            switch (key) {
                ...
                case 'common':
                    return dataList.callback
                        ? dataList.callback(this.nodeData)
                        : function() {
                              console.log('未传入回调');
                          };
            }
