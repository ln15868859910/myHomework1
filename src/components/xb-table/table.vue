    ...
    <div :class="wrapClasses" :style="styles">
        <div :class="classes">
            <div :class="[prefixCls + '-headWrap']" :style="[fixedHeaderStyle,centerTableStyle]" ref="fixedHeaderEle">
                <div :class="[prefixCls + '-title']" ref="title"><slot name="header"></slot></div>
                <div @scroll="handleHorizontalScroll" :class="[prefixCls+'-scrollBar']"><div :style="tableStyle" style="height:1px"></div></div>     
               ...
               <div :class="[prefixCls + '-fixed']" :style="fixedTableStyle" v-if="isLeftFixed" style="height:40px;">
            ...
            <div :class="[prefixCls + '-fixed-right']" :style="fixedRightTableStyle" v-if="isRightFixed" style="height:40px;">
                <div :class="[prefixCls + '-fixed-header']" v-if="showHeader">
                    <table-head
                        fixed="right"
           ...
           <div
            ...
            <div :class="[prefixCls + '-body']" :style="bodyStyle" ref="centerBody" @scroll="handleBodyScroll"
                v-show="!((!data || data.length === 0) || (!rebuildData || rebuildData.length === 0))">
                <table-body
                    ref="tbody"
                    :styleObject="tableStyle"
                    :columns="cloneColumns"
                    :data="rebuildData"
                    :columns-width="columnsWidth"></table-body>
            </div>
            <div :class="[prefixCls + '-fixed']" :style="fixedTableStyle" v-if="isLeftFixed" style="top:0">
            ...
            <div :class="[prefixCls + '-fixed-right']" :style="fixedRightBodyTableStyle" v-if="isRightFixed" style="top:0">
            ...
            <div :class="[prefixCls + '-footer']" ref="footer"><slot name="footer"></slot></div>
        </div>
    </div>
</template>
<script>
...
//                    style.height = this.scrollBarWidth > 0 ? `${this.bodyHeight}px` : `${this.bodyHeight - 1}px`;
            ...
            centerTableStyle(){
                var style={};
                style.width=this.centerWidth+"px";
                return style;
            },
            fixedHeaderStyle(){
                var style={};
        ...
        methods: {
            ...
            handleResize () {
                this.$nextTick(() => {
                    this.centerWidth=parseInt(getStyle(this.$el, 'width'));
