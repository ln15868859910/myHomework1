<template>
<div style="width:100%;">
    <div v-if="showSizer" :class="sizerClasses" style="float:left;">
        <span v-if="sizetext" :class="sizeTextClasses">单页显示：</span>
        <span :class="sizeTextClasses">
            <i-select v-model="currentPageSize" :size="size" :placement="placement" @on-change="onSize(currentPageSize)">
                <i-option v-for="item in pageSizeOpts" :key="item" :value="item" style="text-align:center;">{{ item }} {{ t('i.page.page') }}</i-option>
            </i-select>
        </span>
    </div>
    <ul :class="simpleWrapClasses" :style="styles" v-if="simple" style="float:right;">
        <li
            :title="t('i.page.prev')"
            :class="prevClasses"
            @click="prev">
            <a><i class="ivu-icon ivu-icon-chevron-left"></i></a>
        </li>
        ...
        <li
            ...
            :class="nextClasses"
            @click="next">
            <a><i class="ivu-icon ivu-icon-chevron-right"></i></a>
        </li>
    </ul>
    <ul :class="wrapClasses" :style="styles" v-else style="float:right;">
        ...
        <li :title="t('i.page.prev5')" v-if="currentPage - 3 > 1" :class="[prefixCls + '-item-jump-prev']" @click="fastPrev"><a><i class="ivu-icon ivu-icon-fast-backward"></i></a></li>
        ...
        <li :title="t('i.page.next5')" v-if="currentPage + 3 < allPages" :class="[prefixCls + '-item-jump-next']" @click="fastNext"><a><i class="ivu-icon ivu-icon-fast-forward"></i></a></li>
...
import XbOptions from './options.vue';
