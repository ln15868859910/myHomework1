        ...
        <ul>
            ...
            <li :class="flortRight">
                ...
                <div :class="search" v-if="searchData && status.isInitCompleted">
                    <Select v-show="searchData.data.length > 1 || !searchData.opts.isHideOptsList" :value="searchSelectInitVal" @on-change="setSearchItem" label-in-value style="width:100px">
